  ...
  <nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-custom-menu">
      ...
      <a href="http://localhost/pharmacy/public/reports/stock-expiry">
        <button type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default " data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
          <strong>Expired</strong>
        </button>
      </a>

      <a href="http://localhost/pharmacy/public/purchases/create">
        <button type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default ">
          <strong>Purchase</strong>
        </button>
      </a>

      <a href="http://localhost/pharmacy/public/sells">
        <button type="button" class="btn btn-success btn-flat pull-left m-8 btn-sm mt-10 popover-default " data-toggle="popover" data-trigger="click" data-content='@include("layouts.partials.calculator")' data-html="true" data-placement="bottom">
