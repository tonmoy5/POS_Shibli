	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="pull-right text-white">
				...
				<a href="{{ route('business.getRegister') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif" class="btn bg-maroon btn-flat margin"><b>{{ __('business.not_yet_registered')}}</b> {{ __('business.register_now') }}</a>
